...
class CreateOfflineApprovedRanks extends Migration
{
 public function up(){
 ...
 public function down(){$this->db->query('DROP TABLE IF EXISTS personnel_approved_rank_events');$this->db->query('DROP TABLE IF EXISTS personnel_rank_history');$this->db->query('DROP TABLE IF EXISTS personnel_approved_rank_records');}
}
