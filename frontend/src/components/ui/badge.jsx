...
export function Badge({ variant = 'default', className = '', children, ...props }) {
  const variantStyles = {
    default: 'bg-[#176B43] text-white hover:bg-[#125536] dark:bg-emerald-600 dark:hover:bg-emerald-700 border-transparent',
    secondary: 'bg-[#dcebdd] text-[#123D2A] dark:bg-slate-800 dark:text-slate-100 border-transparent',
    outline: 'text-[#123D2A] dark:text-slate-100 border-[#dde6dd] dark:border-slate-800 bg-transparent',
    destructive: 'bg-rose-500 text-white dark:bg-rose-600 border-transparent',
    success: 'bg-[#dcebdd] text-[#123D2A] dark:bg-emerald-950/80 dark:text-emerald-300 border-[#A9C6B1] dark:border-emerald-800/60',
