...
class RemediateAthleteOfTheYearMaleAward extends Migration
{
    public function up()
    {
        $db = $this->db;
        ...
        $versionExists = $db->table('award_scoring_model_versions')
            ->where('id', '0f85b20c-a461-11f1-a155-08453f707332')
            ->countAllResults();

        if ($versionExists === 0) {
            $db->table('award_scoring_model_versions')->insert([
                'id'                          => '0f85b20c-a461-11f1-a155-08453f707332',
                'award_definition_id'         => '50000001-0000-0000-0000-000000000032',
                'version_number'              => '1.0',
        ...
        $critIds = array_column(
            $db->table('award_criteria')->select('id')->where('award_definition_id', '50000001-0000-0000-0000-000000000032')->get()->getResultArray(),
            'id'
        );
        ...
        $db->table('award_criteria')->insertBatch([
            [
                'id'                       => '50000002-0032-0000-0000-000000000001',
                'award_definition_id'      => '50000001-0000-0000-0000-000000000032',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'code'                     => 'CRIT_ATHLETE_M_ACADEMIC',
            ...
            [
                'id'                       => '50000002-0032-0000-0000-000000000002',
                'award_definition_id'      => '50000001-0000-0000-0000-000000000032',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'code'                     => 'CRIT_ATHLETE_M_SKILLS_ATTITUDE',
            ...
            [
                'id'                       => '50000002-0032-0000-0000-000000000003',
                'award_definition_id'      => '50000001-0000-0000-0000-000000000032',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'code'                     => 'CRIT_ATHLETE_M_PARTICIPATION',
            ...
            [
                'id'                       => '50000002-0032-0000-0000-000000000004',
                'award_definition_id'      => '50000001-0000-0000-0000-000000000032',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'code'                     => 'CRIT_ATHLETE_M_AWARDS',
            ...
            [
                'id'                       => '50000002-0032-0000-0000-000000000005',
                'award_definition_id'      => '50000001-0000-0000-0000-000000000032',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'code'                     => 'CRIT_ATHLETE_M_INTERVIEW',
                'name'                     => 'Interview',
                'weight'                   => 10.00,
                'max_points'               => 10.00,
                'sort_order'               => 5,
        ...
        $db->table('award_criterion_components')->insertBatch([
            [
                'id'               => '50000003-0032-0000-0000-000000000001',
                'criterion_id'     => '50000002-0032-0000-0000-000000000002',
                'code'             => 'COMP_ATHLETE_M_INDIV_SKILLS',
            ...
            [
                'id'               => '50000003-0032-0000-0000-000000000002',
                'criterion_id'     => '50000002-0032-0000-0000-000000000002',
                'code'             => 'COMP_ATHLETE_M_TEAM_SKILLS',
            ...
            [
                'id'               => '50000003-0032-0000-0000-000000000003',
                'criterion_id'     => '50000002-0032-0000-0000-000000000003',
                'code'             => 'COMP_ATHLETE_M_PARTICIPATION',
                'name'             => 'Participation in Sports and Athletic Meets',
            ...
            [
                'id'               => '50000003-0032-0000-0000-000000000004',
                'criterion_id'     => '50000002-0032-0000-0000-000000000004',
                'code'             => 'COMP_ATHLETE_M_AWARDS',
        ...
        $db->table('award_evidence_mapping_rules')->insertBatch([
            [
                'id'                       => '50000004-0032-0000-0000-000000000001',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000002',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000001',
                'rule_code'                => 'MAP_ATHLETE_M_INDIV_SKILLS',
            ...
            [
                'id'                       => '50000004-0032-0000-0000-000000000002',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000002',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000002',
                'rule_code'                => 'MAP_ATHLETE_M_TEAM_SKILLS',
            ...
            [
                'id'                       => '50000004-0032-0000-0000-000000000003',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000003',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000003',
                'rule_code'                => 'MAP_ATHLETE_M_PARTICIPATION',
            ...
            [
                'id'                       => '50000004-0032-0000-0000-000000000004',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000004',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000004',
                'rule_code'                => 'MAP_ATHLETE_M_AWARDS',
        ...
        $db->table('award_scoring_rules')->insertBatch([
            [
                'id'                       => '50000005-0032-0000-0000-000000000001',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000002',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000001',
                'code'                     => 'RULE_ATHLETE_M_INDIV',
            ...
            [
                'id'                       => '50000005-0032-0000-0000-000000000002',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000002',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000002',
                'code'                     => 'RULE_ATHLETE_M_TEAM',
            ...
            [
                'id'                       => '50000005-0032-0000-0000-000000000003',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000003',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000003',
                'code'                     => 'RULE_ATHLETE_M_PARTICIPATION',
            ...
            [
                'id'                       => '50000005-0032-0000-0000-000000000004',
                'scoring_model_version_id' => '0f85b20c-a461-11f1-a155-08453f707332',
                'criterion_id'             => '50000002-0032-0000-0000-000000000004',
                'criterion_component_id'   => '50000003-0032-0000-0000-000000000004',
                'code'                     => 'RULE_ATHLETE_M_AWARDS',
