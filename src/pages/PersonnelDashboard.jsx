  ...
  return (
    <MainLayout>
      <div className="space-y-8 font-sans">
        ...
        {/* ================= SUPPORTING EVIDENCE VAULT & CATEGORY CARDS ================= */}
        <div className="bg-slate-50 rounded-3xl p-6 sm:p-8 border border-slate-200 space-y-6">
          <div>
            <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
              ...
              <span>Supporting Evidence Category Vault</span>
            </h2>
            <p className="text-xs text-slate-500 mt-0.5">
              Click any category card to filter and jump directly to accomplishments under that category.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* Card 1 */}
            <div
              onClick={() => handleCategoryCardClick('Research & Publications')}
              className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-[#2d8a4e] hover:shadow-md transition cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="p-3 rounded-xl bg-[#eef7f0] text-[#2d8a4e] border border-[#cbe6d2]">
                    <BookOpen className="w-5 h-5" />
                  </div>
                  <span className="text-xs font-bold text-slate-400 group-hover:text-[#2d8a4e] transition flex items-center gap-1">
                    Filter timeline <ChevronRight className="w-4 h-4" />
                  </span>
                </div>
                <h3 className="font-bold text-slate-900 group-hover:text-[#2d8a4e] transition text-sm">
                  Research & Publications
                </h3>
                <p className="text-xs text-slate-500 mt-1">
                  Journal papers, Scopus indexed articles, research grants, and books.
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                <span className="font-bold text-slate-700">
                  {accomplishments.filter(a => a.category === 'Research & Publications').length} Documents Proof
                </span>
              </div>
            </div>
            ...
            {/* Card 2 */}
            <div
              onClick={() => handleCategoryCardClick('Seminars & Workshops')}
              className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-[#2d8a4e] hover:shadow-md transition cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Faculty development programs, regional trainings, and conventions.
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                <span className="font-bold text-slate-700">
                  {accomplishments.filter(a => a.category === 'Seminars & Workshops').length} Documents Proof
                </span>
              </div>
            </div>
            ...
            {/* Card 3 */}
            <div
              onClick={() => handleCategoryCardClick('Extension Services')}
              className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-[#2d8a4e] hover:shadow-md transition cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Community literacy programs, technical advisory, and social action.
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                <span className="font-bold text-slate-700">
                  {accomplishments.filter(a => a.category === 'Extension Services').length} Documents Proof
                </span>
              </div>
            </div>
            ...
            {/* Card 4 */}
            <div
              onClick={() => handleCategoryCardClick('Institutional Awards')}
              className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-[#2d8a4e] hover:shadow-md transition cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Araw ng Parangal honors, faculty researcher awards, and plaques.
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                <span className="font-bold text-slate-700">
                  {accomplishments.filter(a => a.category === 'Institutional Awards').length} Documents Proof
                </span>
              </div>
            </div>
            ...
            {/* Card 5 */}
            <div
              onClick={() => handleCategoryCardClick('Certifications & Licenses')}
              className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-[#2d8a4e] hover:shadow-md transition cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  PRC professional licenses, AWS/Cisco cloud and network certifications.
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                <span className="font-bold text-slate-700">
                  {accomplishments.filter(a => a.category === 'Certifications & Licenses').length} Documents Proof
                </span>
              </div>
            </div>
