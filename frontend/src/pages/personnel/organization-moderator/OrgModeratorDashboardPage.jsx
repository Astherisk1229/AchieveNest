...
export default function OrgModeratorDashboardPage({ currentUser }) {
  ...
  const [liveStreamSearchTerm, setLiveStreamSearchTerm] = useState('')
  const [autoLockGuard, setAutoLockGuard] = useState(true)
