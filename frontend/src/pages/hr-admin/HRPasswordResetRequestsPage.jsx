...
export default function HRPasswordResetRequestsPage() {
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-black text-slate-900 dark:text-white tracking-tight">
                Personnel Password Reset Requests
              </h1>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">
              Review institutional password reset requests submitted by faculty and university personnel.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-[#131e2e] rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xs overflow-hidden">
        <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <h3 className="text-xs font-extrabold text-slate-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
            ...
            <span>Personnel Verification Queue</span>
          </h3>
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <h4 className="font-extrabold text-sm text-slate-900 dark:text-white truncate">
                          {req.full_name || 'Personnel Member'}
                        </h4>
                      ...
                      <p className="text-xs font-semibold text-slate-500 truncate mt-0.5">
                        {req.designation || 'Faculty Member'} • {req.institutional_email}
                      </p>
                    </div>
                  </div>
                    ...
                    {isCompleted && (
                      <div className="flex items-center gap-2 text-[11px]">
                        ...
                        <span className="text-slate-600 dark:text-slate-400">
                          {req.handler_name || 'HR Administrator'} on {new Date(req.completed_at || req.updated_at).toLocaleDateString()}
                        </span>
                      </div>
                    )}
              ...
              {resetResult ? (
                <div className="space-y-4 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      For personnel: <strong>{resetResult.full_name || selectedRequestForReset.full_name}</strong> ({resetResult.institutional_email || selectedRequestForReset.institutional_email})
                    </p>
                  </div>
                  ...
                  <div className="p-3.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/50 text-left text-amber-900 dark:text-amber-300 font-medium space-y-1">
                    ...
                    <p className="text-[11px] leading-relaxed">
                      This temporary password will only be shown once and is not stored in the database. Provide it securely to the verified faculty or personnel member. The user will be required to create a permanent password upon logging in.
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  <p className="text-slate-600 dark:text-slate-300 font-medium leading-relaxed">
                    You are about to issue a temporary password for personnel member{' '}
                  ...
                  <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/50 flex items-start gap-2.5 text-xs text-emerald-900 dark:text-emerald-300">
                    ...
                    <span>
                      Please verify the employee's institutional identity before issuing temporary login credentials.
                    </span>
                  </div>
            ...
            <div className="p-6 space-y-4 text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. In-person verification failed, duplicate request..."
