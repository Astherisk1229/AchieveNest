    ...
    <MainLayout>
      <div className="space-y-6 font-sans">
        <div className="bg-[#1b4332] text-white p-6 sm:p-8 rounded-3xl shadow-xl border border-[#245233]">
          <h1 className="text-2xl font-extrabold text-white">OSAD Administration & Recognition Engine</h1>
        ...
        <div className="p-8 rounded-2xl bg-white border border-slate-100 shadow-2xs text-center text-slate-500 text-xs">
          ...
          <p className="font-bold text-slate-800 text-sm">OSAD Araw ng Parangal Ranking Engine & Scanner Gateway</p>
