...
| 3 | `frontend/src/services/authService.js` | 156 | `department_id: user.department_id \|\| null,` | COMPATIBILITY-FIELD | No | Keep inert | Preserved response/session compatibility; not an authorization source | REVIEWED |
