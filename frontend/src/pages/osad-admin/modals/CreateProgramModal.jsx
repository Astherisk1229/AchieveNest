...
export default function CreateProgramModal({ isOpen, onClose, onSubmit, colleges = [] }) {
  const defaultCollegeId = colleges[0]?.id || ''
  ...
  const isDirty = () => (
    ...
    (Boolean(defaultCollegeId) && collegeId !== defaultCollegeId)
  )
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message="Are you sure you want to close? Your unsaved program details will be lost."
