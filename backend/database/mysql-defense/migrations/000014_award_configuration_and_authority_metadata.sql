...
-- 000014_award_configuration_and_authority_metadata.sql
--
-- Phase C: Award Catalog, Award Cycle & Criteria Version Model
-- Additive schema expansion for award scoring model versions, criterion
-- components, rule authority provenance, and lifecycle immutability.
-- ============================================================================

-- 1. Extend award_definitions with authority and versioning columns
...
-- 2. Extend award_criteria with authority, version, and rubric metadata
...
-- 5. Deterministic Seeding of Canonical 40 Criteria across all 15 Awards
...
-- 6. Deterministic Backfills:
-- Update authority statuses on award_definitions according to Phase B governance contract
...
-- Update authority statuses on award_criteria
...
-- Seed initial published Scoring Model Versions (1.0) for all 15 active awards linked to the active cycle
...
-- Link award_criteria to their corresponding active scoring_model_version_id
