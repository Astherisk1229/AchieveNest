...
/**
 * Migration: 2026-08-30-000031_AddAwardEvidenceMappingRules.php
 * Domain: OSAD Awards & Scoring Criteria — Evidence Mapping & Condition Predicates
 * Engine: MySQL 8.4.7 (InnoDB, utf8mb4_unicode_ci)
 */
class AddAwardEvidenceMappingRules extends Migration
{
    public function up()
    {
...
SQL);
    ...
    {
        $this->db->query(<<<'SQL'
DROP TABLE IF EXISTS award_evidence_mapping_conditions;
DROP TABLE IF EXISTS award_evidence_mapping_rules;
SQL);
    }
}
