...
-- 000018_award_candidate_manual_decisions.sql
--
-- Phase I: Authorization, Audit History & Manual Decision Controls
-- Additive schema expansion for attributable manual candidate decisions.
-- ============================================================================
