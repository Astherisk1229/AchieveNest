      ...
      <div className="p-4 rounded-2xl bg-white dark:bg-[#131e2e] border border-slate-200/80 dark:border-slate-800 shadow-2xs">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <select
            ...
            className="py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-extrabold text-slate-700 dark:text-slate-300 focus:outline-none focus:border-[#1b4332] w-full sm:w-auto"
          >
        ...
        {filteredDepartments.map(dept => (
          ...
          >
            <div className="flex items-start justify-between gap-2">
              <div>
                <span className="px-2 py-0.5 rounded-md bg-[#1b4332]/10 text-[#1b4332] dark:text-emerald-400 border border-[#1b4332]/20 font-black text-[10px] uppercase">
                  {dept.college}
                </span>
            ...
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 flex items-center justify-between">
              <div>
                <p className="text-[10px] uppercase font-extrabold text-slate-400">Department Secretary</p>
                {dept.currentSecretary ? (
                  <div className="mt-0.5">
                    <p className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{dept.currentSecretary.name}</p>
                    <p className="text-[10px] text-slate-500">{dept.currentSecretary.email}</p>
                  </div>
                ) : (
                  <p className="text-xs font-bold text-slate-400 italic mt-0.5">No secretary assigned</p>
                )}
              </div>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl font-extrabold text-xs flex items-center gap-1.5 transition cursor-pointer shrink-0 ${
                  dept.currentSecretary
