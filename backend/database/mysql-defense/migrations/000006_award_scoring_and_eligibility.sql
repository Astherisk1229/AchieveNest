...
CREATE TABLE IF NOT EXISTS award_interview_eligibilities (
    ...
    CONSTRAINT fk_interview_eligibility_evaluation FOREIGN KEY (evaluation_id) REFERENCES student_award_evaluations(id) ON DELETE SET NULL,
    CONSTRAINT fk_interview_eligibility_nomination FOREIGN KEY (dean_nomination_id) REFERENCES dean_student_nominations(id) ON DELETE SET NULL,
