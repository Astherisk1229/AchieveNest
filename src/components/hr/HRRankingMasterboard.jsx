...
export default function HRRankingMasterboard({
  portfolios = [],
  searchQuery,
  setSearchQuery,
  departmentFilter,
                  ...
                  <tr key={p.id} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    <td className="py-3.5 px-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-slate-400">{p.personnel_id} • {p.academic_rank}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="py-3.5 px-4">
                      <div className="flex items-center gap-1.5 text-slate-700 dark:text-slate-300 font-medium">
                        ...
                        <span className="truncate max-w-[160px]">{p.department_name}</span>
                      </div>
                    </td>
                    ...
                    <td className="py-3.5 px-4 text-center">
                      <button
                        onClick={() => onSelectAuditPortfolio(p)}
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg font-semibold text-xs text-white bg-emerald-600 hover:bg-emerald-700 transition-all shadow"
                      >
