  ...
  return (
    <div className="px-6 py-3 bg-white dark:bg-[#131e2e] border-t border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-3 font-sans shrink-0">
      <div className="flex items-center gap-2 text-xs font-bold text-slate-700 dark:text-slate-300">
        <CheckCircle2 className={`w-4 h-4 shrink-0 ${isComplete ? 'text-[#064e2b] dark:text-emerald-400' : 'text-amber-500'}`} />
        <span>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="px-5 py-2 rounded-xl bg-[#EFF7F0] hover:bg-[#143326] dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-2xs transition cursor-pointer"
        >
