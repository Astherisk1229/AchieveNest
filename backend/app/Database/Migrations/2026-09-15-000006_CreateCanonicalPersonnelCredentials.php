...
class CreateCanonicalPersonnelCredentials extends Migration
{
    public function up()
    {
    ...
    {
        $this->db->query('DROP TABLE IF EXISTS personnel_credential_events');
        $this->db->query('DROP TABLE IF EXISTS personnel_credentials');
    }
}
