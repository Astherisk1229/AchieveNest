...
class CreateRankPlacementDomain extends Migration
{
    public function up()
    {
    ...
    {
        $this->db->query('DROP TABLE IF EXISTS personnel_rank_placements');
        $this->db->query('DROP TABLE IF EXISTS rank_placement_group_ranks');
        $this->db->query('DROP TABLE IF EXISTS rank_placement_groups');
    }
}
