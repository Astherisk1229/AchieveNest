...
| **Demo Non-Academic Personnel** | `d0000000-0000-0000-0001-000000000004` | `2026-DEMO-004` | `demo.nonacademic.personnel@ndmu.edu.ph` | `personnel` | `non_academic` | N/A | N/A | `ADM_REG` | `personnel` | N/A | Non-academic staff evaluation and HR workflow routing |
| **Demo HR Administrator** | `d0000000-0000-0000-0001-000000000005` | `2026-DEMO-005` | `demo.hr.admin@ndmu.edu.ph` | `hr_admin` | `non_academic` | N/A | N/A | `ADM_REG` | `hr_staff` | N/A | HR directory, personnel evaluation oversight, and ranking |
