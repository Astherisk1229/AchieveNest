...
class CreateHrFinalRankReviews extends Migration
{
 public function up(){
 ...
 public function down(){$this->db->query('DROP TABLE IF EXISTS personnel_hr_final_rank_events');$this->db->query('DROP TABLE IF EXISTS personnel_hr_final_rank_reviews');}
}
