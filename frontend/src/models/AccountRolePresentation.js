...
export const ACCOUNT_ROLE_PRESENTATIONS = {
  hr_staff: {
    ...
    defaultUserData: {
      ...
      administrative_unit: 'Human Resource Management & Development Office (HRMDO)',
  ...
  osad_staff: {
    ...
    defaultUserData: {
      ...
      administrative_unit: 'Office of Student Affairs & Services (OSAD)',
  ...
  personnel: {
    ...
    defaultUserData: {
      ...
      program_affiliations: ['Bachelor of Science in Computer Science'],
