...
class ReconcileAuthoritativeFacultyRankTransitions extends Migration
{
    ...
    {
        // Non-destructive by policy: rollback must not reactivate unsupported
        // transitions or delete catalog edges that may have existed previously.
        // A future policy change requires an explicit reconciliation migration.
    }
}
