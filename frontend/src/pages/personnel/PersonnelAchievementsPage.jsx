    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full border text-xs font-bold flex items-center gap-2 transition cursor-pointer ${selectedStatus === 'Verified'
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full border text-xs font-bold flex items-center gap-2 transition cursor-pointer ${selectedStatus === 'Pending Review'
        ...
        {stats.returned > 0 && (
          <button
            ...
            className={`px-4 py-2 rounded-full border text-xs font-bold flex items-center gap-2 transition cursor-pointer ${selectedStatus === 'Returned'
                    ...
                    <div className="bg-[#16834a] h-32 p-4 flex flex-col items-center justify-center text-white relative">
                      ...
                      <div className="absolute top-3 right-3 flex items-center gap-1.5 opacity-90 group-hover:opacity-100 transition z-10">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-full backdrop-blur-md transition cursor-pointer ${item.is_favorited ? 'bg-amber-400 text-slate-900 shadow-sm' : 'bg-white/20 hover:bg-white/30 text-white'
                            }`}
