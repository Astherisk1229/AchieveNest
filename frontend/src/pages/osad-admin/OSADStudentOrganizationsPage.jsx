      ...
      <div className="bg-white dark:bg-[#131e2e] rounded-2xl p-5 sm:p-6 border border-slate-200/80 dark:border-slate-800 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 self-start md:self-auto">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-[#1b4332] hover:bg-[#143326] text-white font-extrabold text-xs transition shadow-xs flex items-center gap-1.5 cursor-pointer"
          >
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="px-2 py-0.5 rounded bg-emerald-50 dark:bg-emerald-950/60 text-[#2d8a4e] dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60 text-[10px] font-extrabold uppercase flex items-center gap-1">
                ...
                <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                  <div className="bg-slate-50 dark:bg-slate-900/60 p-2.5 rounded-xl border border-slate-100 dark:border-slate-800 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-white dark:bg-slate-800 hover:bg-emerald-50 text-[#1b4332] dark:text-emerald-300 font-extrabold text-[11px] border border-slate-200 dark:border-slate-700 transition cursor-pointer flex items-center gap-1 shadow-2xs"
                    >
                      <ShieldCheck className="w-3 h-3 text-[#2d8a4e]" />
                      <span>Assign</span>
                    </button>
                  </div>
                </div>
