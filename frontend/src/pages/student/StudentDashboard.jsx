...
import DigitalBarcodeIDCard from './DigitalBarcodeIDCard'
import { 
  Trophy, 
  CheckCircle2, 
  Clock, 
            ...
            {['All', 'Academic', 'Leadership', 'Community', 'Sports'].map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-xl text-xs font-extrabold transition whitespace-nowrap shrink-0 cursor-pointer ${
                    isSelected 
